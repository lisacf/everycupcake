...
(function() {
  jQuery(function() {
    ...
    $('form').on('click', '.add_instructions', function(event) {
      var regexp, time;
    ...
    $('form').on('click', '.add_fields', function(event) {
      var ingredientid, ingredienttokenid, measurediv, measurename, nameofunit, newdiv, newdivunit, regexp, time, units;
      time = new Date().getTime();
      regexp = new RegExp($(this).data('id'), 'g');
      $(this).before($(this).data('fields').replace(regexp, time));
      ...
      $('.measure_id').change(function() {
        var escaped_measure, measure, options, selectedmeasure, selectedunitclass;
        ...
        if (options) {
          ...
          return $("#" + selectedunitclass).addClass("chosen-like");
        } else {
          $("#" + selectedunitclass).empty();
          return $("#" + selectedunitclass).parent().hide();
        }
      });
      return event.preventDefault();
    });
    ...
    $.each($('.inputtoken'), function(key, value) {
      return $("#" + value.id).tokenInput('/ingredients.json', {
        theme: 'facebook',
    ...
    $('.measure_id').change(function() {
      ...
      if (options) {
        $("#" + selectedunitclass).html(options);
        return $("#" + selectedunitclass).show();
      } else {
        $("#" + selectedunitclass).empty();
        return $("#" + selectedunitclass).hide();
      }
    });
    $("input[type='radio']").change(function() {
      if ($("input[type='radio']:checked").val() === "filling" || $("input[type='radio']:checked").val() === "frosting") {
        return $('#bake_instructions').hide();
      } else {
        return $('#bake_instructions').show();
      }
    });
    return $('form').on('click', 'input[type=range]', function(event) {
      var divname;
      divname = '.' + this.id + ' p:first';
      return $(divname).text(this.value);
    });
  });
...
function createMarker(place) {
  var image = "/assets/minicupcake.png";
...
(function() {
  jQuery(function() {
    return $('document').foundation.clearing.js;
  });
